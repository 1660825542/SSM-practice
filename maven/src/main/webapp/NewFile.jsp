...
<head>
	...
	<script type="text/javascript" src="${Path}/comm/jquery-2.1.4.js"></script>
	 ...
	 <link rel="stylesheet" type="text/css" href="${Path}/comm/bootstrap-3.3.7-dist/css/bootstrap.min.css">   
    <script type="text/javascript" src="${Path}/comm/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
	<title></title>
</head>
<body>
<div class="container">
...
<script type="text/javascript">
		...
		function create_users_pagenav(data){
			...
			var prePageLi = $("<li></li>").append(
					$("<a></a>").append("&laquo;"));
			if (data.dbinfo.pageInfo.hasPreviousPage==false) {
